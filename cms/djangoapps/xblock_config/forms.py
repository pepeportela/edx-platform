...
from xblock_config.models import CourseLTIConsumerHideFieldsFlag

log = logging.getLogger(__name__)


class CourseLTIConsumerHideFieldsAdminForm(forms.ModelForm):
    """
    Form for LTI consumer course-specific configuration to verify the course id.
    """

    class Meta(object):
        model = CourseLTIConsumerHideFieldsFlag
        fields = '__all__'
